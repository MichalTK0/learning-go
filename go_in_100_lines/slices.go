...
func main() {
	...
	frameworks := []string{ // Leading brackets are blank []. Putting stuff in here will make this an array, not a slice.
		"React", "Vue", "Angular", "Svelte",
		"Laravel", "Django", "Flask", "Fiber",
	}

	jsFrameworks := frameworks[0:4:4]          // length 4 capacity 4, frameworks[start:end:capacity]
	frameworks = append(frameworks, "Meteor")  // not possible with arrays, go allocates more space under the hood. Kinda like a list in python.
